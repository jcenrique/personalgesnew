...
use App\Notifications\NotificacionAprobarSabado;
use Filament\Actions\Action;
use Filament\Notifications\Notification;
use Filament\Support\Icons\Heroicon;

class AprobarSabadoAction extends Action
{
    protected function setUp(): void
    {
        ...
        $this->tooltip(__('Aprobar sábado trabajado para que el usuario pueda disfrutar de día de descanso'));
        $this->icon('far-calendar-check');
        $this->color('success');
        $this->modalHeading(__('Aprobar sábado trabajado'))
        ...
        $this->action(function ($record, $data, $livewire) {
            ...
            $user->notify(new NotificacionAprobarSabado($record));

            Notification::make()
                ->title(__('Sábado trabajado aprobado'))
                ->body(__('El sábado trabajado para el :fecha ha sido aprobado. El usuario podrá disfrutar de su día de descanso el :fecha_disfrute.', [
