...
return [
    ...
    */
    ...
    'localization' => [
        'enabled' => true,
        'key' => 'filament-shield::filament/admin/filament-shield.resource_permission_prefixes_labels',
    ],
    ...
    */
    ...
    'custom_permissions' => [
         'ManageUsers:User' => 'Gestión Usuarios',
        'ManageUserInZona:User' => 'Gestión de zonas usuarios',
    ],
